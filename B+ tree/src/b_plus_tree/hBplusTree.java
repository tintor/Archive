...
public class hBplusTree extends BplusTree {
	...
	public static BplusTree Initialize(String treefileName, String blockfileName, int PrefixLength) throws Exception {
		hBplusTreeBytes tree = (hBplusTreeBytes) hBplusTreeBytes.Initialize(treefileName, blockfileName, PrefixLength);
		return new hBplusTree(tree);
	}

	public static BplusTree Initialize(java.io.RandomAccessFile treefile, java.io.RandomAccessFile blockfile,
			int PrefixLength, int CultureId, int nodesize, int buffersize) throws Exception {
		hBplusTreeBytes tree = (hBplusTreeBytes) hBplusTreeBytes.Initialize(treefile, blockfile, PrefixLength,
				CultureId, nodesize, buffersize);
		return new hBplusTree(tree);
	}
	...
	public static BplusTree Initialize(java.io.RandomAccessFile treefile, java.io.RandomAccessFile blockfile,
		...
		hBplusTreeBytes tree = (hBplusTreeBytes) hBplusTreeBytes
				.Initialize(treefile, blockfile, PrefixLength, CultureId);
		return new hBplusTree(tree);
	}
