...
public class BufferFile {
	...
	public BufferFile(java.io.RandomAccessFile fromfile, int buffersize, long seekStart) throws Exception {
	...
	public static BufferFile SetupFromExistingStream(java.io.RandomAccessFile fromfile, long StartSeek) throws Exception {
	...
	public void getBuffer(long buffernumber, byte[] toArray, int startingAt, int length) throws Exception {
	...
	public void setBuffer(long buffernumber, byte[] fromArray, int startingAt, int length) throws Exception {
		...
		if (buffernumber > this.nextBufferNumber()) {
			throw new BufferFileException("cannot skip buffer numbers from " + this.nextBufferNumber() + " to "
					+ buffernumber);
		}
		long seekPosition = this.bufferSeek(buffernumber);
	...
	public static void copyBytesTo(byte[] fromArray, byte[] toArray, int destinationIndex) throws Exception {
	...
	public static void Store(int TheInt, byte[] ToArray, int atIndex) throws Exception {
	...
	public static void Store(short TheShort, byte[] ToArray, int atIndex) throws Exception {
	...
	public static void Store(long TheLong, byte[] ToArray, int atIndex) throws Exception {
	...
	public static long RetrieveLong(byte[] ToArray, int atIndex) throws Exception {
		int limit = LONGSTORAGE;
		if (atIndex + limit > ToArray.length) {
			throw new BufferFileException("can't access beyond end of array");
		}
	...
	public static short RetrieveShort(byte[] ToArray, int atIndex) throws Exception {
		int limit = SHORTSTORAGE;
		if (atIndex + limit > ToArray.length) {
			throw new BufferFileException("can't access beyond end of array");
		}
