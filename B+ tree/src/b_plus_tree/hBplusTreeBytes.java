...
public class hBplusTreeBytes extends xBplusTreeBytes {
	...
	public static xBplusTreeBytes Initialize(String treefileName, String blockfileName, int PrefixLength, int CultureId,
		...
		return new hBplusTreeBytes(BplusTreeBytes.Initialize(treefileName, blockfileName, PrefixLength, CultureId,
	...
	public static xBplusTreeBytes Initialize(java.io.RandomAccessFile treefile, java.io.RandomAccessFile blockfile,
		...
		return new hBplusTreeBytes(BplusTreeBytes.Initialize(treefile, blockfile, PrefixLength, CultureId, nodesize,
