...
public class BplusTree implements IStringTree {
	...
	public static BplusTree Initialize(String treefileName, String blockfileName, int KeyLength, int CultureId,
		...
		BplusTreeBytes tree = BplusTreeBytes.Initialize(treefileName, blockfileName, KeyLength, CultureId, nodesize,
				buffersize);
	...
	public static BplusTree Initialize(String treefileName, String blockfileName, int KeyLength) throws Exception {
	...
	public static BplusTree Initialize(java.io.RandomAccessFile treefile, java.io.RandomAccessFile blockfile,
			int KeyLength, int CultureId, int nodesize, int buffersize) throws Exception {
		BplusTreeBytes tree = BplusTreeBytes.Initialize(treefile, blockfile, KeyLength, CultureId, nodesize, buffersize);
		return new BplusTree(tree);
	}

	public static BplusTree Initialize(java.io.RandomAccessFile treefile, java.io.RandomAccessFile blockfile,
			int KeyLength, int CultureId) throws Exception {
