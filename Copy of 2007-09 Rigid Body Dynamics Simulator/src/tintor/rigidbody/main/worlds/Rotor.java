...
public class Rotor extends World {
	public Rotor() {
		final Body b = new Body(Vector3.Zero, Quaternion.Identity, Shape.box(30, 4, 30), 1e3);
		b.angVel = new Vector3(0, 0.5, 0);
		b.elasticity = 0;
		add(b);
		...
		final Body c = new Body(new Vector3(0, -4, 0), Quaternion.Identity, Shape.box(100, 4, 100), 1e3);
		c.elasticity = 0;
		c.dfriction = 0;
		c.sfriction = 0;
		c.color = GLA.orange;
